...
const HomePage = () => {
    ...
    function crearSala() {
        ...
        if (!multiplayerService.socket ||
            multiplayerService.socket.readyState !== WebSocket.OPEN) {
                                                ...
                                                >
                                                    {leaderboardData.length > 0 ? (
                                                        ...
                                                        >
                                                            ...
                                                            />
                                                            <Typography>No hay datos de usuarios
                                                                    ...
                                                                    <Grid item xs={12} sm={4}>
                                                                        <Box>
                                                                            <Typography variant="subtitle1"
                                                                                        ...
                                                                                        fontWeight="medium">
                                                                                Sesión
                                                                                del {formatDate(session.createdAt).split(" ")[0]}
                                                                            </Typography>
                                                                            <Typography
                                                                                variant="caption"
                                                                                color="text.secondary"
                    ...
                    <>
                        ...
                        >
                            <Typography variant="h6" component="div" fontWeight="bold">
                                Detalles de la sesión del {formatDate(selectedSession.createdAt).split(" ")[0]} con
                                dificultad{" "}
                                            ...
                                            >
                                                <ListItemText
                                                    ...
                                                    secondary={
                                                        ...
                                                        >
                                                            {q.question}
                                                            {expandedQuestion === index ? <ExpandLessIcon/> :
                                                                <ExpandMoreIcon/>}
                                                        </Typography>
                                                    }
                                                />
                                                    ...
                                                    <Grid container spacing={2}>
                                                        <Grid item xs={12} sm={6}>
                                                            ...
                                                            >
                                                                ...
                                                                <Typography
                                                                    variant="body2">{q.correctAnswer}</Typography>
                                                            </Box>
                                                        </Grid>
                                                        <Grid item xs={12} sm={6}>
                                                            <Box
