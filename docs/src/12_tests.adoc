...
El objetivo de las pruebas de cobertura establecido ha sido el del 80% de cobertura de código. A continuación, se muestra la cobertura de código obtenida en cada uno de los servicios y componentes desarrollados:
